...
#dikey birleştirme
dikey_matris = np.vstack((matris1,matris2))
print("dikey birleştirme:\n",dikey_matris)

#yatay birleştirme
yatay_matris = np.hstack((matris1,matris2))
print("yatay matris:\n",yatay_matris)

liste_matris = np.array([[1,2],[5,6],[7,4]])
print("liste matris:\n",liste_matris)

#np.zeros --- sıfır matrisi
#np.ones -- birler matrisi
#np.arange --- belirli bir araklıta matris oluşturma
#np.linspace --- bilirli araklıkta eşit aralıklı sayılarla matris oluşturur.
#np.random.rand -- rastgele sayılardan oluşan matris
